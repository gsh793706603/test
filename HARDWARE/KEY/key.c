...
{ 
	...
	GPIO_InitStructure.GPIO_Pin  = GPIO_Pin_12;//KEY2
...
void TCRT5000_Init(void)
{
	...
	GPIO_PinRemapConfig(GPIO_Remap_SWJ_JTAGDisable,ENABLE);				//由于其中几个引脚默认为上电调试口，因此要关闭swj
	
	GPIO_InitStructure.GPIO_Pin  = GPIO_Pin_3 | GPIO_Pin_4 | GPIO_Pin_5;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPD; //下拉输入	  
	GPIO_Init(GPIOB, &GPIO_InitStructure);//初始化GPIOB.3 4 5
